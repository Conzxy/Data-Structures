...
假设最后一层全是叶子结点，高度从叶子结点这层以0开始，则堆的高度为logn-1(没有向下取整，而是精确值)，1/4的调用最多需要1次交换，1/8的调用最多需要2次交换，依次类推，那么时间复杂度的公式就可以表示为：<br>
![](https://img-blog.csdnimg.cn/20200617131609957.gif)<br>
